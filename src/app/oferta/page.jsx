...
export const metadata = {
  title: "Публічна оферта — умови надання аудиторських і бухгалтерських послуг",
  description:
    "Ознайомтеся з умовами співпраці з компанією «Аудит Консультант» — порядок надання аудиторських, бухгалтерських і юридичних послуг для клієнтів по всій Україні.",
};
  ...
  return (
    <div className={styles.policy}>
      ...
      <p className={styles.text}>
        ...
        <Link href="/">https://consulting.lviv.ua/</Link>. Даний договір є
      ...
      <p className={styles.text}>
        ...
        <Link href="/">https://consulting.lviv.ua/</Link> створений для
      ...
      <p className={styles.text}>
        1.5. Продавець – Товариство з обмеженою відповідальністю «БУХГАЛТЕР
        КОНСУЛЬТАНТ» (ідентифікаційний код 45494012), юридична особа, яка
        створена і діє відповідно до чинного законодавства України,
        місцезнаходження якої: 79040, м. Львів, вул. Вільхова буд. 32.
      </p>
      <h2>2. Предмет Договору</h2>
      <p className={styles.text}>
        2.1. Продавець зобов’язується передати у власність Покупцю Товар або
        Послугу, а Покупець зобов’язується оплатити і прийняти на умовах цього
        Договору.{" "}
      </p>
      <p className={styles.text}>
      ...
      <p className={styles.text}>
        3.3.2. адреса, за якою слід доставити Товар або Послугу (якщо доставка
        до адреси Покупця);{" "}
      </p>
      ...
      <p className={styles.text}>
        3.4. Найменування, кількість, ціна обраного Покупцем Товару або Послуги
      ...
      <p className={styles.text}>
        ...
        якісної послуги Покупцю при покупці Товару або Послуги в
        інтернет-магазині.
      </p>
      <p className={styles.text}>
      ...
      <p className={styles.text}>
        ...
        (запропоновані умови придбання Товару або Послуги), шляхом оформлення
      ...
      <p className={styles.text}>
        ...
        вказані на сайті у гривнях без ПДВ.
      </p>
      <p className={styles.text}>
      ...
      <p className={styles.text}>
        5.2.1 Змінювати умови цього Договору, а також ціни на Товари та послуги,
        в односторонньому порядку, розміщуючи їх на сайті Інтернет-магазину. Всі
      ...
      <p className={styles.text}>
        ...
        <br />
        ТОВ "БУХГАЛТЕР КОНСУЛЬТАНТ"
        <br />
        79040, м. Львів, вул. Вільхова, буд. 32
        <br />
        Код ЄДРПОУ: 45494012
        <br />
        Банківські реквізити:
        <br />
        IBAN UA343052990000026007011023210
        <br />
        в АТ КБ "ПРИВАТБАНК"
        <br />
        тел.: +38 (073) 418 71 47
        <br />
        email: audit@consulting.lviv.ua
        <br />
      </p>
    </div>
  );
