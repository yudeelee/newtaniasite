          ...
          <div className={styles.sectionBody}>
            <div className={styles.sectionText}>
              <div className='text'>
                ...
                <br />
                Хто такі резиденти Дія.Сітy чи варто обрати цю революційну
                ...
                <br />
                - якщо дохід від видів діяльності, які передбачені відповідним
                переліком у вас 90% від вашого доходу компанії
                <br />
                - якщо середньооблікова кількість працівників/гіг спеціалісті за
                період 9 або більше;
                <br />
                - винагорода середня по підприємству спеціалістам 1200 євро або
                більше👌
                <br />
                ...
                - 5% ПДФО;
                <br />
                - 22% ЄСВ від мінімальної зарплати (1562 грн, станом на лютий
                2024 року);
                <br />
                - 1,5% військовий збір <br />
                (Все як для ФОП, тільки додатково платите військовий збір 1.5%)
                <br />
                Корпоративний податок (платимо за результатами року):
                <br />
                - 9% податок на виведений капітал (вперше в Україні, нова схема
                оподаткування діяльності підприємства) або <br />
                - 18% податок на прибуток;
                <br />
                Наша думка, щодо цієї системиоподаткування.
                <br />
                Я завжди за щось нове, інноваційне, класне, сучасне. Тому
                однозначно рекомендую для ІТ сфери, податки та вимоги абсолютно
                адекватні.
                <br />
                Чи допомагаємо ми з супроводом?
                <br />
                Так! Ми допомагаємо у всіх процесах переходу, або початку роботи
                на цій системі оподаткування. <br />
                ...
                <br />
                - формування гіг-контрактів, первинних документів, договорів;
                <br />
